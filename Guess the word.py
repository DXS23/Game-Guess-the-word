...
def play(word):
    ...
    while not guessed and tries > 0:
        guess = input('Ведите букву или слово: ').upper()
        if len(guess) == 1 and guess.isalpha:
            if guess in guessed_letters:
                print('Такая буква уже есть', guess)
                print('Осталось попыток:', tries)
                ...
                print('Хороший выбор, буква', guess, 'есть в слове!')
                print('Осталось попыток:', tries)
                guessed_letters.append(guess)
            ...
            if guess in guessed_words:
                ...
                print('Слово', guess, 'неправильное.')
                tries -= 1
...
new_game = 'дa'
while new_game.lower() == 'дa':
    word = get_word()
    play(word)
    again = input('Сыграем еще раз? (да или нет):')
    if again == 'да':
        continue
    else:
